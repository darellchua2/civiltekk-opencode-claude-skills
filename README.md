...
- **Subagents are profile-immune.** All 148 skills stay on disk and every skill has either a frontmatter skill-allow consumer (legacy `permission.skill` spelling, auto-translated by v2) or a lean slot — nothing is orphaned under lean.
