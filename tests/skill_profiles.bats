...
#      exactly 44 allow rules + a skill deny-all-first; full leaves the
...
@test "apply-skill-profile: lean rewrites scratch config to 44 allows + deny-all-first" {
