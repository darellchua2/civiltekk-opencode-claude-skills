...
- [ ] **2.4** Advisory pre-composition: hand-compose core+opencode-overlay per pilot per the contract's pipeline prose, record a preliminary meaning-parity verdict per agent in the contract appendix, explicitly marked non-authoritative
