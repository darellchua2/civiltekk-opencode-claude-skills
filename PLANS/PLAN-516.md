...
GATE e5dbcbf tier=full lint=n.a typecheck=n.a build=n.a unit=t(bats tests/ 529/529) e2e=n.a — post-merge re-gate on origin/main-merged tree (LEARNINGS index conflict resolved in main's format; purge proof + registry unchanged)
