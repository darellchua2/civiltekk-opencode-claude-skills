...
6. **Deploy-script comment literals** — `deploy/setup.sh:3240-3241` and `deploy/setup.ps1:1900` hardcode "46 primary-visible skills" / "shipped 105-allow allowlist" in prose comments above `run_skill_profile` (counts auto-derive functionally; the comments drift). Missed by PLAN-404 rev 2 — caught at code review.
